...
<div class="login_pop popcon" id="login_pop">
    <div id="login_clearbox" class="popclose"><a href="javascript:box_clearDiv()"></a></div>
                ...
                <div class="log_field ebLog_form">
                    <form onsubmit="return false">
                        <div class="info_input clearfix">
                            ...
                            <input class="log_input_box" id="iusername" name="username" type="text" value="" maxlength="50" tabIndex="1"/>
                        </div>
                        <div class="info_input clearfix">
                            <label for="iuserpwd"><span>密</span>码</label>
                            <input class="log_input_box" id="iuserpwd" type="password" value="" maxlength="50" tabIndex="2"/>
                        </div>
                        <div class="info_input log_remb clearfix">
                            <div class="log_checkbox left">
                                <input id="remember" type="checkbox" checked="" name="remember" tabIndex="3"/>
                        ...
                        <div class="login_submit mart30">
                            <input class="btn ebsmbbtn" type="submit" name="submit" value="登 录"/>
                        </div>
                    </form>
                </div>
            </div>
