...
<s:portlet url="/pl/goods-list.htm" var="goods" param="flag_special=0&orderbyIndex=3"/>
...
<jsp:useBean id="menu" class="java.lang.String"/><c:set var="menu" value="c-special"/>
        ...
        <div id="content">
            ...
            <c:forEach var="unit" items="${goods.list}" varStatus="status">
                <c:if test="${param.editingId==unit.id}">
                    ...
                    <tags:list-add list="${rowData}"><input type="text" name="flag_special" size="3" value="${unit.flag_special}"></tags:list-add>
                ...
                <c:if test="${param.editingId!=unit.id}">
                    ...
                    <tags:list-add list="${rowData}">${unit.id}</tags:list-add>
                    <tags:list-add list="${rowData}">${unit.title}</tags:list-add>
                    <tags:list-add list="${rowData}">${unit.flag_special}</tags:list-add>
                    <tags:list-add list="${rowData}">
            ...
            <c:if test="${empty param.editingId}">
                ...
                <tags:list-add list="${rowData}"> - </tags:list-add>
                <tags:list-add list="${rowData}"><input type="text" name="flag_special"  size="3"></tags:list-add>
