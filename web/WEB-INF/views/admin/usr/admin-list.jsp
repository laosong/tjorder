...
<div id="centered">
    ...
    <c:import charEncoding="utf-8"  url="../AdminTopNav.jsp?t=usr" />
        <div id="bottom-main">
            <c:import charEncoding="utf-8"  url="../AdminMenu-User.jsp?m=admin" />
                <div id="content">
                    <h1>管理员列表</h1>
                    <tags:btn-new id="btn-new" actionScript="window.location.href='admin-add-edit.htm'" />
                    ...
                    <c:forEach var="unit" items="${usr.list}" varStatus="status">
                        ...
                        <tags:list-add list="${rowData}"><a href="admin-add-edit${unit.id}.htm">${unit.login_name}</a></tags:list-add>
                        ...
                        <tags:list-add list="${rowData}"><tags:btn-del id="delBtn_${unit.id}" actionScript="window.location.href='admin-del${unit.id}.htm?toUrl='+window.location.href"/></tags:list-add>
                    </c:forEach>
                    ...
                    <tags:table-row list="${colInfo}"  title="创建时间" width="15%" cssClass="right"/>
