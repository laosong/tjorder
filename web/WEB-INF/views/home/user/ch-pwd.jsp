...
<div id="container">
    ...
    <div id="content" class="clearfix mart10">
        <form:form id="userForm" commandName="cmd" action="/home/user/ch-pwd.htm" method="post">
            <div class="personal_con m790 right">
                <h3 class="con_til">密码修改</h3>
                <div class="per_del tablestyle mart10">
                    <div class="per_form mart20">
                        <h2 style="margin-left:100px;color: red"><form:errors path="*"/></h2>
                        <input type="hidden" name="toUrl" value="/home/user/ch-pwd-succ.htm"/>
                        <div class="per_area">
                            <label for="firstName">原密码：</label>
                            <input type="password" name="login_pass" value="" id="firstName" />
                        </div>
                        <div class="per_area">
                            <label for="name">新密码：</label>
                            <input type="password" name="new_pass" value="" id="name" />
                        </div>
                        <div class="per_area">
                            <label for="email">确认密码：</label>
                            <input type="password" name="pwd_confirm" value="" id="email" />
                        </div>
                        <div class="per_submit f14px fb mart10"><a href="javascript:userForm.submit();" class="btnCom btnCom_reb"><span>确定</span></a></div>
                    </div>
                </div>
            </div>
        </form:form>
